          ...
          <div className="max-w-[330px] w-full">
            ...
            <ul className="flex flex-col gap-3">
              <li className="flex gap-4.5">
                ...
                inside chandpole near police station chandpole jodhpur
              </li>
                ...
                <span className="flex-shrink-0">
                  ...
                  >
                    <path
                      fillRule="evenodd"
                      clipRule="evenodd"
                      d="M6.62 10.79C8.06 13.62 10.38 15.94 13.21 17.38L15.27 15.32C15.66 14.93 16.29 14.82 16.77 15.07C17.98 15.68 19.32 16.05 20.75 16.05C21.44 16.05 22 16.61 22 17.3V20.75C22 21.44 21.44 22 20.75 22C10.07 22 2 13.93 2 3.25C2 2.56 2.56 2 3.25 2H6.7C7.39 2 7.95 2.56 7.95 3.25C7.95 4.68 8.32 6.02 8.93 7.23C9.18 7.71 9.07 8.34 8.68 8.73L6.62 10.79Z"
                      fill="#3C50E0"
                    />
                  </svg>
                </span>
        ...
        <div className="max-w-[1170px] mx-auto px-4 sm:px-8 xl:px-0">
          <div className="flex gap-5 flex-wrap items-center justify-between">
            <p className="text-dark font-medium">
              &copy; {year}. All rights reserved by Vednix.
            </p>
